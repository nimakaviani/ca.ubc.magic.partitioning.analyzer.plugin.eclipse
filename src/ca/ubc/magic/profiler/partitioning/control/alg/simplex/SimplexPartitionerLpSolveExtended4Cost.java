...
public class SimplexPartitionerLpSolveExtended4Cost extends SimplexPartitionerLPSolveExtended {
...
//       initEdges();
   ...
   protected int getMaxIterations(){
       return SimplexPartitionerLpSolveExtended4Cost.CLOUD_MAX_ITERATIONS;
   }
}
